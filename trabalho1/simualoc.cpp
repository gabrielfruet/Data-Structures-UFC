...
bool SimulAloc::inicializar(int ini, int tam){
    this->inicio = ini;
    this->tamanho = tam;
    try{
...
bool SimulAloc::desalocar(int ini, int tam){
    /* 
...
SimulAloc::Noh* SimulAloc::unir(Noh* a, Noh* b){
